...
case1:   .asciiz "f(-1) should be -6, and it is: "
case2:   .asciiz "f(0) should be 20, and it is: "
case3:   .asciiz "f(1) should be 7, and it is: "
case4:   .asciiz "f(2) should be -38, and it is: "
case5:   .asciiz "f(3) should be -32, and it is: "
case6:   .asciiz "f(4) should be 49, and it is: "
case7:   .asciiz "f(5) should be 21, and it is: "

# FIXME Разместите значения из вашего варианта в этом массиве 
output: .word   -6, 20, 7, -38, -32, 49, 21
